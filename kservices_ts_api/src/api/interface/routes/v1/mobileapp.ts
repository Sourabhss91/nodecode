...
import { getRemarks, setRemarks, getListRemarks, setNotificationToken } from "../../controllers/app/mobileapp/remarksController";
import { appVersion } from "../../controllers/app/mobileapp/versionController";
import { getlist, getCallBase, setCallSchedule, getOutgoingCampaign, getFollowUpCalls, endcallReasonList,updateEndCallReason, changeScheduleStatus } from "../../controllers/app/mobileapp/callDetailsController";
import { agentInsight, getCdrMisscall, getTypeDetail,getAgentList } from "../../controllers/app/mobileapp/agentController";
import { getVoiceMail } from "../../controllers/app/mobileapp/voiceMailController";
import { deleteAddressbook, setCustomerName, getAddressbookList, getAddressbook, updateCustomerName, getAddressbookListNew } from "../../controllers/app/mobileapp/addressBookController";
import { userBreakIn, userBreakOut, userBreakList } from "../../controllers/app/mobileapp/userBreakController";
import { clickToCall } from "../../controllers/app/mobileapp/clickToCallController";
import { getCities } from "../../controllers/app/mobileapp/getCitiesController";
import { getProducts } from "../../controllers/app/mobileapp/getProductsController";
import {  getLeadStatus,getLeadSource,getLeadSettings,addManualLead,getUniqueCalls,getLeadCustomerDetails,getLeadDetailProduct,getLeadDetailNotes,getScheduledCalls,getLeadDetailCalls,getAddressbookDetail,setAddressbookDetail,updateUniqueCalls,masterApiSourceCityProductStatus,addCustomerNote,setFollowUpCall,masterApiupdateUniqueCallsAddress } from "../../controllers/app/mobileapp/leadSettingsController";

import {   } from "../../controllers/app/sme/uniqueCallsController";
