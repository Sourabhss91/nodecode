...
import { fetchCallProfile, getSmeIvrFlow } from "../../controllers/app/v3/ivr/profileController";
import { setLiveCalls, upddateLiveCalls, deleteLiveCalls, setUniqueCalls, blacklistIvrCalls, keepAlive } from "../../controllers/app/v3/ivr/LiveCallsController";
import { agentExtention, setAgentFree, setAgentBusy, setAgentCdr, setAgentOut, setCustomerCdr, releaseAgent, getSmeRecord } from "../../controllers/app/v3/ivr/agentController";
import { getFreeAgent, getFreeAgentParallelRinging } from "../../controllers/app/v3/ivr/agentSearchController";
import { getAddressbook } from "../../controllers/app/v3/ivr/addressBookController";
import { saveRecording, saveFailedRecordingInfo, getFailedRecordingInfo, updateFailedRecordingRetry } from "../../controllers/app/v3/ivr/recordingController";
import { recordingUpload, saveRecordingData } from "../../controllers/app/v3/ivr/s3RecordingController";
import { endCallCdr, callEndIvrNotify, updateCallBalance } from "../../controllers/app/v3/ivr/endCallCdrController";
import { getclicktocall, getAutoDialerNo, updateClick2Call, getAppOutCallDetail, getAppOutCallDetailNew, getAutoDialerNoNew, updateClick2CallLiveCall } from "../../controllers/app/v3/ivr/clicktocallController";
import { endcallSms } from "../../controllers/app/v3/ivr/sendSms";
import { revenueProcess, revenueProcessToday, updateSiteStatus } from "../../controllers/app/v3/ivr/revenueProcessController";
import { getToken } from "../../controllers/app/v3/ivr/tokenController";
...
export const IVR = (router: express.Router): void => {
  ...
  /** Get Sme Record */
  router.post("/ivr/getSmeIvrFlow", verifyTokenIVR, getSmeIvrFlow);
