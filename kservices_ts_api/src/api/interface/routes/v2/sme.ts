...
import { getSetting, updateSetting, downloadFile, checkSmeAutodialerPermission, generateReport, getDownloadReport, getWebrtcNumber, getTrainingVideos, getFaq } from "../../controllers/app/v2/sme/getSettingController";
import { setCities } from "../../controllers/app/v2/sme/setCitiesController";
import { setProducts } from "../../controllers/app/v2/sme/setProductsController";
import { setCustomerName, getCustomerName } from "../../controllers/app/v2/sme/setCustomerNameController";
import { authSignin, generateToken, generateAccessKey } from "../../controllers/app/v2/sme/authSigninController";
import { forgotPassword, resetPassword, verifyOtpForgotPassword, forgotChangePassword } from "../../controllers/app/v2/sme/forgotPasswordController";
import { getRemarks, setRemarks, getListRemarks } from "../../controllers/app/v2/sme/getRemarksController";
import { getCities } from "../../controllers/app/v2/sme/getCitiesController";
import { getProducts } from "../../controllers/app/v2/sme/getProductsController";
import { getAllPrompt } from "../../controllers/app/v2/sme/getPromtsController";
import { updateUniqueCalls, getUniqueCalls, getCallsPerformance, addManualLead, deleteUniqueDetail, demoRequest, leadTransfer, uploadLeadData, bulkLeadTransfer, updateLeadStatusOnLiveCall, viewFrequency, copyCampaignToLead } from "../../controllers/app/v2/sme/uniqueCallsController";
import { checkAppDetail } from "../../controllers/app/v2/sme/getAppVersionController";
import { getlist, setFollowUpCall, getMergeCalls, clearLiveCall, setCallColumnSettings, getAgentLiveCallLead, getAgentLiveCallCampaignLead } from "../../controllers/app/v2/sme/callDetailsController";
import {
  getAgentStatus,
  getAgentList,
  getActiveAgentList,
  ...
  isAgentMobileExist,
  getLiveApr
} from "../../controllers/app/v2/sme/agentController";
import { getSmeRecordings } from "../../controllers/app/v2/sme/recordingController";
import { getTypeDetail, getAgentQueue } from "../../controllers/app/v2/sme/userController";
import { getComplaintList, setComplaint } from "../../controllers/app/v2/sme/complaintController";
import { getGroupdetail } from "../../controllers/app/v2/sme/groupDetailsController";
...
import { getLeadSettings, setLeadSettings, getLeadCustomerDetails, getLeadSource, addLeadSource, deleteLeadSource, editLeadSource, getLeadDetailProduct, getLeadDetailNotes, getLeadDetailRemarks, getLeadDetailCalls, getTotalLeadStatusSummary, getTotalLeadSourceSummary, getTotalLeadProductSummary, getTotalLeadTypeSummary, getTotalLeadFollowupSummary, getLeadStatus, addLeadStatus, deleteLeadStatus, editLeadStatus, getTotalLeadCitySummary, isdeletedAgentLeadExist, getWhatsapp, addWhatsappTemplate, deleteWhatsappTemplate, addWhatsAppMapping, getWhatsappMapping, getWhatsappEnum, getWhatsappMappingIvrCount, editWhatsappTemplate } from "../../controllers/app/v2/sme/leadSettingsController";
import { getVoiceMail } from "../../controllers/app/v2/sme/voiceMailController";
import { getSmeLongcodes, getAgentLongcodes } from "../../controllers/app/v2/sme/longcodesController";
import { setNotificationToken, revokeNotificationToken, getNotifications, markAllAsReadNotification } from "../../controllers/app/v2/sme/notificationController";
import { getivrflow, createivrflow, deleteIvrCallFlow, getIvrByUniqueFlowId, getIvrFlowCount, updateivrflow, getIvrFlowlongcodeId, getQueue, updateQueue, addQueue, getQueueAssignedAgents, getMedia, uploadMediaFile, addMedia, generateMedia, updateMedia } from "../../controllers/app/v2/sme/ivrFlowController";
import { uploadBaseList, changeScheduleStatus } from "../../controllers/app/v2/sme/callScheduleController";
import { uploadSoundFile } from "../../controllers/app/v2/sme/uploadSoundFileController";
import { systemDetail, getSystemDetailGraphData } from "../../controllers/app/v2/sme/systemDetailController";
import {
  getSmsTemplate,
  setSmsTemplate,
  getSmsCampaign,
 ...
 sendCommSms,
 getCommSmsSettings,
} from "../../controllers/app/v2/sme/smsController";
import { getCampaignMediaFile, uploadCampaignMediaFile, setCampaignMediaFile, uploadScheduleCampaign, addCampaign, getOutgoingCampaign, getScheduledCalls, addCampaignBase, updateOutgoingCampaign, getOutgoingCampaigAgentWise, getAgentCampaign, addAutodialerCampaignBase, getPastScheduledCalls, getTodayScheduledCalls, getUpcomingScheduledCalls, uploadLead, getCampaignAssignedAgents, saveNonWorkingFlow, saveNonWorkingDays, getNonWorkingFlow, getNonWorkingMappingFlow, getNonWorkingDays, uploadNonWorkingFile, getUploadedFileColumnsData, addInformativeObdCampaignBase, addAutodialerCampaignBaseNew,  getOutgoingCampaignBeta, getCampaignBetaAssignedAgents, updateIsPicked} from "../../controllers/app/v2/sme/campaignMediaController";

import { getBlacklistNumbers, setBlackWhiteListNumbers } from "../../controllers/app/v2/sme/blocklistController";
import { getAddressbookDetail, setAddressbookDetail, addNewCustomer, addCustomerNote } from "../../controllers/app/v2/sme/contactsController";
import { setLongcodes, getEndCallReasonsList, updateEndCallReason } from "../../controllers/app/v2/sme/longcodeController";
import { getSmeProductPackage,getsmePackagePaymentHistory } from "../../controllers/app/v2/sme/planDetailsController";
import { setThirdPartyLeadSettings,getThirdPartyLeadSettings,getAllThirdPartyLeadSettings,checkFacebookAccessToken,getFacebookAdsCampaign,getFacebookAdsetData,getFacebookAdsData,setFacebookLeadSettings,getFacebookLeadSettings,getfacebookCampaignSettings,setFacebookCampaignData,getfacebookCampaignAssignedAgentId,getfacebookCampaignadsdata,updatefaceBookCampaignStatus,deleteFacebookCampaigndata } from "../../controllers/app/v2/sme/thirdPartyLeadController";

import { setAgentFree } from "../../controllers/app/v2/ivr/agentController";
...
import {
  ...
  getAgentQueueRequestValidate,
  getMediaRequestValidate,
  uploadMediaFileRequestValidate,
  addMediaRequestValidate,
  generateMediaRequestValidate,
  updateMediaRequestValidate,
  updateIsPickedRequestValidate,
  getLiveAprRequestValidate,
  getWhatsappRequestValidate,
  addWhatsappTemplateRequestValidate,
  deleteWhatsappTemplateValidate,
  addWhatsAppMappingValidate,
  getWhatsappMappingValidate,
  getWhatsappEnumValidate,
  editWhatsappTemplateValidate
} from "../../../domain/validator/v2/sme.validator";

import {  setAgentFreeValidate } from "../../../domain/validator/v2/ivr.validator";
...
export const SMERoute = (router: express.Router): void => {
  ...
  router.post("/sme/:id/getBlacklistNumbers", verifyTokenSME, validateRequest(getSettingRequestValidate), getBlacklistNumbers);
  ...
  router.post("/sme/:id/getAgentQueue", verifyTokenSME, validateRequest(getAgentQueueRequestValidate), getAgentQueue);

  router.post("/sme/:id/getMedia", verifyTokenSME, validateRequest(getMediaRequestValidate), getMedia);

  router.post("/sme/:id/uploadMediaFile", verifyTokenSME, validateRequest(uploadMediaFileRequestValidate), uploadMediaFile);

  router.post("/sme/:id/addMedia", verifyTokenSME, validateRequest(addMediaRequestValidate), addMedia);

  router.post("/sme/:id/generateMedia", verifyTokenSME, validateRequest(generateMediaRequestValidate), generateMedia);

  router.post("/sme/:id/updateMedia", verifyTokenSME, validateRequest(updateMediaRequestValidate), updateMedia);

  router.post("/sme/:id/updateIsPicked", verifyTokenSME, validateRequest(updateIsPickedRequestValidate), updateIsPicked);

  router.post("/sme/:id/getLiveApr", verifyTokenSME, validateRequest(getLiveAprRequestValidate), getLiveApr);

  router.post("/sme/:id/getWhatsapp", verifyTokenSME, validateRequest(getWhatsappRequestValidate), getWhatsapp);

  router.post("/sme/:id/addWhatsappTemplate", verifyTokenSME, validateRequest(addWhatsappTemplateRequestValidate), addWhatsappTemplate);

  router.post("/sme/:id/deleteWhatsappTemplate/", verifyTokenSME, validateRequest(deleteWhatsappTemplateValidate), deleteWhatsappTemplate);

  router.post("/sme/:id/addWhatsAppMapping/", verifyTokenSME, validateRequest(addWhatsAppMappingValidate), addWhatsAppMapping);

  router.post("/sme/:id/getWhatsappMapping/", verifyTokenSME, validateRequest(getWhatsappMappingValidate), getWhatsappMapping);

  router.post("/sme/:id/getWhatsappEnum/", verifyTokenSME, validateRequest(getWhatsappEnumValidate), getWhatsappEnum);

  router.post("/sme/:id/getWhatsappMappingIvrCount/", verifyTokenSME, validateRequest(getWhatsappEnumValidate), getWhatsappMappingIvrCount);

  router.post("/sme/:id/editWhatsappTemplate/", verifyTokenSME, validateRequest(editWhatsappTemplateValidate), editWhatsappTemplate);
};
