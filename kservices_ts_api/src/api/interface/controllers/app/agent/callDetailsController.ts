...
import { FindCallList, totalRecordList, getAgentCampaignSummaryData } from "../../../../domain/models/agent.model";
import { callListFetchRequest } from "../../../../domain/entities/agent.entity";
