...
import { endCallCdrRequest, endCallStatsRequest } from "../../../../../domain/entities/v3/ivr.entity";
 ...
 export const endCallCdr = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      ...
      queue_name: req.body.queue_name ? req.body.queue_name : 0,
      ...
      triedAgentList: req.body.triedAgentList ? req.body.triedAgentList : "" 
    };
              ...
              if (response.length > 0) {
                ...
                InsertEndCallCdr(reqData, reqDataNew, (err: any, response1: any) => {
                  if (err) {
                    ...
                    // insert mongodb
                    reqData['aid'] = (response1['insertedId'] !== undefined) ? response1['insertedId'] : 0;
                    reqData['lastInsertedId'] = data["id"];
                    //InsertEndCallCdrMongo(reqData,(err:any,response:any)=>{})
