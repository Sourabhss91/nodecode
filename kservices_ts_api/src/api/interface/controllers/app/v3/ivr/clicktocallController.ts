...
import { getclicktocallRequest, getAutoDialerNoRequest, updateClick2CallRequest, getAppOutCallDetailRequest } from "../../../../../domain/entities/v3/ivr.entity";
...
export const updateClick2CallLiveCall = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      ...
      agent_no: req.body.agent_no,
      response_msg: req.body.response_msg,
      call_status_v3: req.body.call_status_v3,
    ...
    await UpdateClick2Call(reqData, (err: any, response: any) => {
      if (err) {
        glogger('ERR', ""+req.headers.sessionid+"", '/ivr/' + req.params.id + '/updateClick2CallLiveCall', "UpdateClick2Call, error:" + err);
        return ErrorEmptyResponse(res, err);
      } else {
