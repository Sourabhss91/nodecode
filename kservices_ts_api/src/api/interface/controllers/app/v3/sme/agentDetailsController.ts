...
import { FindagentDetails, FetchAgentReport, AgentReportTotalRecord, FindAgentReportData, FetchOutCallsReport } from "../../../../../domain/models/v3/sme.model";
import { getAgentdetailRequestValidate, fetchAgentReport, AgentReportDataRequestValidate } from "../../../../../domain/entities/v3/sme.entity";
