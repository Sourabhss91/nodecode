...
import { FindProfileDetail, UpdateUserStatus, getAgentQueueData } from "../../../../../domain/models/v3/sme.model";
import { fetchRequest, getTypeDetailRequest } from "../../../../../domain/entities/v3/sme.entity";
...
export const getAgentQueue = async (req: Request, res: Response) => {
  try {
    ...
    await getAgentQueueData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
