...
import { fetchAgentstatusRequest, getFreeAgentRequest, getFreeAgentRequestV2, getFreeAgentEqualRequest, getFreeAgentParallelRingingRequest } from "../../../../../domain/entities/v2/ivr.entity";
        ...
        //case which is lead already soft sticky.
          ...
          if (req.body.alogtype == "Random") {
            ...
            getSerialAgent(reqDataOrig, (err: any, responseSH: any) => {
              ...
              console.log("lets find the Even Call Distribution agent..");
              getEqualCallDistAgent(reqDataOrig, (err: any, responseRand: any) => {
                if (err) {
                  glogger('ERR', ""+req.headers.sessionid+"", '/ivr/'+req.params.id+'/getFreeAgent', "getEqualCallDistAgent, error:"+err);
                  return ErrorEmptyResponse(res, err);
                } else {
