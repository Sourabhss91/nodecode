...
import { UpdateUniqueCall,GetUniqueCalls ,TotalUniqueCall,getCallsPerformanceData, checkManualLeadExist, addManualLeadData, deleteUniqueDetailData, leadTransferData, uploadLeadNumbers, bulkLeadTransferData, updateManualLeadData, updateLeadStatusOnLiveCallData, getFrequencyCalls, bulkLeadStatusTransferData, checkAddressBookCustomerExist, addAddressBookCustomer, updateAddressBookCustomer, followupTransferData, copyCampaignToLeadData } from "../../../../../domain/models/v2/sme.model";
import { checkTotalLeadStatusSummaryExist, updateTotalLeadStatusSummaryData, insertTotalLeadStatusSummaryData, checkTotalLeadSourceSummaryExist, updateTotalLeadSourceSummaryData, insertTotalLeadSourceSummaryData, checkTotalLeadProductSummaryExist, updateTotalLeadProductSummaryData, insertTotalLeadProductSummaryData, checkTotalLeadTypeSummaryExist, updateTotalLeadTypeSummaryData, insertTotalLeadTypeSummaryData, checkTotalLeadCitySummaryExist, updateTotalLeadCitySummaryData, insertTotalLeadCitySummaryData  } from "../../../../../domain/models/v2/ivr.model";
import { updateUniqueCallsRequest,getUniqueCallsRequest,fetchCallperformance } from "../../../../../domain/entities/v2/sme.entity";
                ...
                if (err) {
                  ...
                  if(response3 && response3.length == 0) {
                    let reqContactData: any = {
                      "smeId": parseInt(req.params.id),
                      "customer_number_primary": finalUploadLeadArray[l].customerNumber ? "+91"+finalUploadLeadArray[l].customerNumber.substring(finalUploadLeadArray[l].customerNumber.length - 10) : "" ,
                      "customer_number": finalUploadLeadArray[l].customerNumber ? "+91"+finalUploadLeadArray[l].customerNumber.substring(finalUploadLeadArray[l].customerNumber.length - 10) : "" ,
