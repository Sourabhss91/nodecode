...
import { FindProfileDetail, UpdateUserStatus, getAgentQueueData } from "../../../../../domain/models/v2/sme.model";
import { fetchRequest, getTypeDetailRequest } from "../../../../../domain/entities/v2/sme.entity";
