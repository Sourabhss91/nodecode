...
import {
} from "../../../../../domain/entities/v2/sme.entity";
...
export const checkFacebookAccessToken = async (req: Request, res: Response) => {
    try {
        ...
        var options = {
            'method': 'GET',
            'url': 'https://graph.facebook.com/v18.0/oauth/access_token?grant_type=fb_exchange_token& client_id=' + req.body.clientId + '&client_secret=' + req.body.secretKey + '&fb_exchange_token=' + req.body.token,
            'headers': {
...
export const getFacebookAdsCampaign = async (req: Request, res: Response) => {
    try {
        ...
        var options = {
            'method': 'GET',
            'url': 'https://graph.facebook.com/v18.0/me?fields=id,name,adaccounts{campaigns{name}}&access_token=' + req.body.token,
            'headers': {
                'Content-Type': 'application/x-www-form-urlencoded',
            }
        };
...
export const getFacebookAdsetData = async (req: Request, res: Response) => {
    try {
        ...
        var options = {
            'method': 'GET',
            'url': 'https://graph.facebook.com/v18.0/' + req.body.campaignId + '/adsets?fields=adlabels,name,status,id&access_token=' + req.body.token,
            'headers': {
                'Content-Type': 'application/x-www-form-urlencoded',
            }
        };
...
export const getFacebookAdsData = async (req: Request, res: Response) => {
    try {
        ...
        var options = {
            'method': 'GET',
            'url': 'https://graph.facebook.com/v18.0/' + req.body.adsetId + '/ads?fields=name,status,id&access_token=' + req.body.token,
            'headers': {
                'Content-Type': 'application/x-www-form-urlencoded',
            }
        };
