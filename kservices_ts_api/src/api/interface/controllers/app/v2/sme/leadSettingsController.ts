...
import {
  ...
  getWhatsappData,
  addWhatsappTemplateData,
  deleteWhatsappTemplateData,
  addWhatsAppMappingData,
  getWhatsappMappingData,
  deleteWhatsAppMappingData,
  getWhatsappEnumData,
  getWhatsappMappingIvrCountData,
  editWhatsappTemplateData,
  deleteWhatsappMapping
} from "../../../../../domain/models/v2/sme.model";
import { insertTotalLeadStatusSummaryData, insertTotalLeadSourceSummaryData, insertTotalLeadProductSummaryData, insertTotalLeadTypeSummaryData, insertTotalLeadCitySummaryData  } from "../../../../../domain/models/v2/ivr.model";
import { fetchRequest, fetchLeadCustomerDetailRequest, updateLeadSettingsRequest, getLeadSourceRequest, getLeadStatusRequest} from "../../../../../domain/entities/v2/sme.entity";
...
export const getWhatsapp = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
    };
    
    await getWhatsappData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp listing Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const addWhatsappTemplate = async (req: Request, res: Response) => {
  try {
    ...
    let reqData: any = {
      ...
      user_fields: JSON.stringify(req.body.user_fields),
      custom_header_key: req.body.custom_header_key,
      custom_header_value: req.body.custom_header_value,
      json_field: req.body.json_field,
      fixed_field: JSON.stringify(req.body.fixed_field),
      custom_field: JSON.stringify(req.body.custom_field),
      status: 1,
      insert_date_time: req.body.insert_date_time,
      update_date_time: req.body.update_date_time,
    };
    
    await addWhatsappTemplateData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp Template Added Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const deleteWhatsappTemplate = async (req: Request, res: Response) => {
  try {
    ...
    await deleteWhatsappTemplateData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        deleteWhatsappMapping(reqData, (err: any, response: any) => {
          if (err) {
            return ErrorEmptyResponse(res, err);
          } else {
        ...
        return SuccessResponse(res, "Whatsapp Template Deleted Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const addWhatsAppMapping = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
      ivr_flow_id: req.body.ivrFlowId,
      insert_date_time: req.body.insert_date_time,
      update_date_time: req.body.update_date_time,
    };

    var filterData = req.body.data;
  
    await deleteWhatsAppMappingData(reqData, async(err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        for (let data of filterData) {
          if(data["isChecked"] == true){
            reqData.whatsapp_enum_id = data["id"];
            reqData.template_id = data["templateId"];
            await addWhatsAppMappingData(reqData, (err: any, response1: any) => {
              if (err) {
                return ErrorEmptyResponse(res, err);
              } else {
        ...
        return SuccessResponse(res, "Whatsapp Template Mapped Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const getWhatsappMapping = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
      ivr_flow_id: req.body.ivr_flow_id ? req.body.ivr_flow_id : 0,
    };
    
    await getWhatsappMappingData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp mapping data listing Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const getWhatsappEnum = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
    };
    
    await getWhatsappEnumData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp enum data listing Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const getWhatsappMappingIvrCount = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
    };
    
    await getWhatsappMappingIvrCountData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp ivr count listing Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
...
export const editWhatsappTemplate = async (req: Request, res: Response) => {
  try {
    let reqData: any = {
      sme_id: parseInt(req.params.id),
      name: req.body.name,
    ...
    await editWhatsappTemplateData(reqData, (err: any, response: any) => {
      if (err) {
        return ErrorEmptyResponse(res, err);
      } else {
        return SuccessResponse(res, "Whatsapp updated Successfully", response);
      }
    });
  } catch (e) {
    logger.error(e);
