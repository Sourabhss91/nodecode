...
import { FindProducts } from "../../../../../domain/models/v2/mobileapp.model";
import {  } from "../../../../../domain/entities/v2/mobileapp.entity";
...
export const getProducts = async (req: Request, res: Response) => {
  try {
    ...
    await FindProducts(reqData, (err: any, response: any) => {
      if (err) {
