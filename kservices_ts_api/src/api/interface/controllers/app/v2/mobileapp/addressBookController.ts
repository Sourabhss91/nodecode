...
import { DeleteAgentAddressBook,FindCustomerBook, UpdateAddressBookCustomername,InsertAddressBookCustomername ,FindAddressbookList, FindSingleAddressbook, checkEmailExistAddressBook, FindAddressbookListNew} from "../../../../../domain/models/v2/mobileapp.model";
import { deleteAddressBookRequest,setCustomerNameRequest,getAddressbookListRequest,FetchAddressbookRequest, getAddressbookListRequestNew } from "../../../../../domain/entities/v2/mobileapp.entity";
