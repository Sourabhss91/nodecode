...
import { FindRemarks, SetRemarks, FindListRemarks } from "../../../../../domain/models/v2/agent.model";
import { remarksRequest, setRemarksRequest, fetchListRemarksRequest } from "../../../../../domain/entities/v2/agent.entity";
