...
import { addrevenueProcess, checkAgentHangedData, UpdateAgentStatusFree, UpdateFreeAgentiming, updateKommunoSiteStatus, addLogSiteStatusWise } from "../../../../domain/models/ivr.model";
import { fetchRevenueRequest, fetchAgentstatusRequest } from "../../../../domain/entities/ivr.entity";
