...
} from "../../../../domain/models/sendsms.model";
import { endCallCdrRequest } from "../../../../domain/entities/ivr.entity";
...
export const endcallSms = async (req: Request, res: Response) => {
  try {
    ...
    const agentNumberWithoutPlus = req.body.agentNo ==0 ? req.body.agentNo : req.body.agentNo.replace(/\+/g, '');
    let reqData: any = {
    ...
    glogger('IMP', ""+req.body.sessionId+"", 'endcallSms', "API Request Customer No:" + req.body.customerNo);
