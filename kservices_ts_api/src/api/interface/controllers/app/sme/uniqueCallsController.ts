...
import { UpdateUniqueCall,GetUniqueCalls ,TotalUniqueCall,getCallsPerformanceData, checkManualLeadExist, addManualLeadData, deleteUniqueDetailData, leadTransferData, uploadLeadNumbers, bulkLeadTransferData, updateManualLeadData, updateLeadStatusOnLiveCallData, getFrequencyCalls, bulkLeadStatusTransferData, checkAddressBookCustomerExist, addAddressBookCustomer, updateAddressBookCustomer, followupTransferData, copyCampaignToLeadData } from "../../../../domain/models/sme.model";
...
import { updateUniqueCallsRequest,getUniqueCallsRequest,fetchCallperformance } from "../../../../domain/entities/sme.entity";
